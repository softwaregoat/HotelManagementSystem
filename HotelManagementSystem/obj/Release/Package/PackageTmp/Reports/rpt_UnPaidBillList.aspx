<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="rpt_UnPaidBillList.aspx.vb" Inherits="HotelManagementSystem.rpt_UnPaidBillList" %>
...
<body>
    ...
    <div class="wrapper">
        ...
        <asp:SqlDataSource ID="sqlBillList" runat="server" ConnectionString="<%$ ConnectionStrings:ConStringHotelMngSys %>" SelectCommand=" SELECT        GUEST_ID, GuestName, Address, PhoneNo, Check_In_Date, Check_Out_Date, Total, TotalTAX, GrandTotal, DiscountAmount, NetAmount, PaidAmount, BalanceAmount, PaymentType, Status FROM            GuestInformation WHERE        (Check_In_Date &gt;= @Check_In_Date AND Check_In_Date &lt;= @Check_In_Date2) AND (BalanceAmount > 0) ">
            <SelectParameters>
