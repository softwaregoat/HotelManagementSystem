<%@ Page Title="Check In Edit" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"  CodeBehind="CheckInEdit.aspx.vb" Inherits="HotelManagementSystem.CheckInEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="modal modal-info fade" id="myModal" role="dialog">
        ...
        <div class="modal modal-primary fade"  id="myModalInvoiceInfo" role="dialog">
        <div class="modal-dialog modal-sm">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtGuestID"  placeholder="Guest ID" CssClass="form-control validate[required]"  AutoPostBack="true" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <i class="required_form_item ">* Requerido</i>
                            <asp:TextBox ID="txtAddress" CssClass="form-control validate[required]" placeholder="Nationality" runat="server"></asp:TextBox>
                        </div>
</div>
                             <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:TextBox ID="txtIDNo" CssClass="form-control validate[required]"  placeholder="ID No" style="width:170px" runat="server"></asp:TextBox>
                                  <asp:Button ID="btnSearch" CausesValidation="false" runat="server" Text="Buscar" CssClass="btn btn-info" /> </div>
  ...
  <div class='input-group date' id='datetimepicker2' onblur="ValidateCheckOut()">
               ...
               <span class="glyphicon glyphicon-calendar"></span>
                        ...
                        <div class="box-header with-border">
                          ...
                          <div class="row">
                            <div class="col-md-2">
                                ...
                                <i class="required_form_item ">* Requerido</i>
                                <asp:DropDownList ID="ddlPayType" Width="100%" CssClass="form-control select2 validate[required,custom[integer],minSize[1]]" ClientIDMode="Static" runat="server">
                        ...
                        <div class="col-md-12" style="padding-top:5px;padding-left:5px;padding-right:5px; overflow:auto">
                              <asp:GridView ID="gvBill"  Width="100%"  CssClass="table table-responsive" ShowFooter="true" OnRowDataBound = "OnRowDataBound"   OnSelectedIndexChanged="gvBill_SelectedIndexChanged" runat="server" AutoGenerateColumns="true" OnRowDeleting="OnRowDeleting">
                        ...
                        <div class="row hidden">
                            <div class="col-md-4">
                                <label for="ddlRoomNo">Room No</label>
                                <i class="required_form_item ">* Requerido</i>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-footer pull-right"> 
                        <asp:Button ID="btnCheckInSubmit" CssClass="btn btn-info" runat="server" Text="Save"></asp:Button> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            tday = new Array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"),
                ...
                d = new Date, nday = d.getDay(), nmonth = d.getMonth(), ndate = d.getDate(), nyear = d.getYear(), nhour = d.getHours(), nmin = d.getMinutes(), nsec = d.getSeconds(), nyear < 1e3 && (nyear += 1900), 0 == nhour ? (ap = " AM", nhour = 12) : nhour <= 11 ? ap = " AM" : 12 == nhour ? ap = " PM" : nhour >= 13 && (ap = " PM", nhour -= 12), nmin <= 9 && (nmin = "0" + nmin), nsec <= 9 && (nsec = "0" + nsec), ndate <= 9 && (ndate = "0" + ndate);
            monthNum = (parseInt(nmonth) + 1), monthNum <= 9 && (monthNum = "0" + monthNum);
            var checkIn = $('#<% =txtCheckInDate.ClientID %>').val();
            var checkOut = $('#<% =txtCheckOutDate.ClientID %>').val();


            if (checkIn == "" && checkOut == "") {
                $('#<% =txtCheckInDate.ClientID %>').val(ndate + "/" + monthNum + "/" + nyear + " " + nhour + ":" + nmin + ap);
