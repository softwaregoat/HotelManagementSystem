<%@ Page Title="Change Room" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ChangeRoom.aspx.vb" Inherits="HotelManagementSystem.ChangeRoom" %>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Current Room Information</h3>
                        </div>
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Change To</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label for="ddlChangeRoomNo">Room No</label>
                                <i class="required_form_item ">* Required</i>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:TextBox ID="txtChangeRentnDay" CssClass="form-control " placeholder="Rent/Day" ReadOnly="true" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="txtReason">Reason</label>
                            <asp:TextBox ID="txtReason" CssClass="form-control" placeholder="Reason" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer">
                        <asp:Button ID="btnSubmit" CssClass="btn btn-info" runat="server" Text="Submit"></asp:Button>
                        <asp:HyperLink ID="HyperLink5" runat="server" CssClass="btn btn-info" NavigateUrl="~/ChangeRoom.aspx">Reset</asp:HyperLink>
                    </div>
                </div>
                <!-- /.box -->
            </div>
