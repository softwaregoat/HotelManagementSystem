<%@ Page Title="User Role" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UserRoles.aspx.vb" Inherits="HotelManagementSystem.UserRoles" %>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
           ...
           <div class="form-group">
               <label for="txtRoleName">Role</label> <i class="required_form_item "> * Required</i>
               <asp:TextBox ID="txtRoleName" CssClass="form-control validate[required]" placeholder="Role Name" runat="server"></asp:TextBox>
           </div>
       </div>
              <div class="box-footer">
                <asp:Button ID="btnSubmit" CssClass="btn btn-info" runat="server" Text="Submit" > </asp:button>
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-info" NavigateUrl="~/UserRoles.aspx">Reset</asp:HyperLink>
              </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
            ...
            <div class="box-body">
                ...
                <asp:GridView ID="GridView1" CssClass="gvv table table-bordered table-striped table-responsive" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:HyperLinkField Text="EDIT" DataNavigateUrlFields="ROLE_ID" DataNavigateUrlFormatString="~/UserRoles.aspx?act=edit&amp;id={0}">
                            <ControlStyle CssClass="label label-info" />
                        </asp:HyperLinkField>
                        <asp:HyperLinkField Text="DEL." DataNavigateUrlFields="ROLE_ID" DataNavigateUrlFormatString="~/UserRoles.aspx?act=del&amp;id={0}">
