...
Public Class rpt_FoodServicePaidSales
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            Try
                ...
                lblReportType.Text = "Paid Sales List, From :" & Format(Date_From, "dd-MMM-yyy").ToString() & ", To : " & Format(Date_To, "dd-MMM-yyy").ToString()
