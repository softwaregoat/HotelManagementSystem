<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="rpt_GuestListCheckOut.aspx.vb" Inherits="HotelManagementSystem.rpt_GuestListCheckOut" %>
...
<body>
    ...
    <form  id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="sqlServiceDat" runat="server" ConnectionString="<%$ ConnectionStrings:ConStringHotelMngSys %>" SelectCommand="SELECT        GuestInformation.GUEST_ID, GuestInformation.GuestName, GuestInformation.Address, GuestInformation.PhoneNo, GuestInformation.ID_Type, GuestInformation.ID_No, GuestInformation.Gender, GuestInformation.Purpose, 
                         ...
                         GuestInformation ON RoomDetails.ROOM_ID = GuestInformation.No_Of_Day WHERE ((GuestInformation.Check_Out_Date &gt;= @Check_Out_Date) AND (GuestInformation.Check_Out_Date &lt;= @Check_Out_Date2) AND (GuestInformation.Status LIKE '%' + @Status + '%')) ">
            <SelectParameters>
