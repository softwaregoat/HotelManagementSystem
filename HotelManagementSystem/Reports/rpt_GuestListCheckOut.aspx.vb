...
Public Class rpt_GuestListCheckOut
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            Try
                ...
                Dim Rep_Status As String = Request.QueryString("status").ToString()
                hfDateFrom.Value = Date_From
                hfDateTo.Value = Date_To
                hfStatus.Value = Rep_Status

                lblReportType.Text = "From :" & Format(Date_From, "dd-MMM-yyy").ToString() & ", To : " & Format(Date_To, "dd-MMM-yyy").ToString() & ", " & Rep_Status
